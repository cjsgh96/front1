...
public class 객체정렬하기_라이브러리 {

	public static void main(String[] args) {
		
		Score0[] arr0 = new Score0[3];		
		arr0[0]= new Score0("이길동",90,71);
		arr0[1]= new Score0("김길동",70,99);
		arr0[2]= new Score0("박길동",90,89);
		...
		//정상적으로 Arrays.sort기능을 사용하려면 각 객체는  Comparable가지고 있어야 한다.		
		//즉 Score클래스를 작성할 때  Comparable인터페이스를 구현해야 한다
		Score1[] arr = new Score1[3];		
		arr[0]= new Score1("이길동",90,71);
		arr[1]= new Score1("김길동",70,99);
		arr[2]= new Score1("박길동",90,89);
